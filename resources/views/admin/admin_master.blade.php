...
<head>
	...
	<!--[if lt IE 9]>
		...
		<link id="ie-style" href="{{asset('admin/css/ie.css')}}" el="stylesheet">
	<![endif]-->
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="{{url('/dashboard')}}"><span> Dashboard</span></a>
				...
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li> 
							...
							<ul>
								<li><a class="submenu" href="{{url('/post/create')}} "><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Post</span></a></li>
								<li><a class="submenu" href="/post/"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Post</span></a></li>
						...
						{{-- color module --}}
						<li> 
							<a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet">TAG</span><span class="label label-important"></span></a>
							<ul>
								<li><a class="submenu" href="{{url('/color/create')}} "><i class="icon-file-alt"></i><span class="hidden-tablet"> Add  tag</span></a></li>
								<li><a class="submenu" href="/color/"><i class="icon-file-alt"></i><span class="hidden-tablet"> All tag</span></a></li>
